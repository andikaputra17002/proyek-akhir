                            ...
                            <div class="modal-body" id="modal-body">
                                <form action="" method="post" id="formpendaftaran" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-12 data-field-col">
                                        ...
                                        <select class="select-name form-control" id="name" name="name">
                                            <option value=""></option>
                                    ...
                                    <div class="col-sm-12 data-field-col">
                                        ...
                                        <select class="select-dokter form-control" id="nama_dokter" name="nama_dokter">
                                            <option value=""></option>
                                            @foreach ($dokter as $data)
                                            <option value="{{ $data->id }}">{{ $data->nama_dokter }}</option>
                                            @endforeach
                                    ...
                                    <div class="col-sm-12 data-field-col">
                                        ...
                                        <select class="form-control select-jam" id="jam_praktek" name="jam_praktek">
                                            <option value=""></option>
                                            @foreach ($jampraktek as $data)
                                            <option value="{{ $data->id }}">{{ $data->jam_praktek }}</option>
                                            @endforeach
...
{{-- <script src="{{ asset('app-assets/air-datepicker/air-datepicker.js') }}"></script> --}}
    ...
    $('#formpendaftaran').submit(function (e) {
            e.preventDefault();
                ...
                success: function(response) {
                    ...
                    $('#formpendaftaran').trigger("reset"); //form reset
                    $('#tutup').trigger("reset"); //form reset
                    $('#exampleModal').modal('hide'); //modal hide
                    // $('#exampleModal')[0].reset(); //modal hide
